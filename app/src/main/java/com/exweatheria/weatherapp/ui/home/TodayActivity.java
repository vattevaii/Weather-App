...
public class TodayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Weather every Hour");
        Bundle extras;
        ...
        rView = findViewById(R.id.todaysRV);
    ...
    private void sendRequestTommorrowIO(String longitude,String latitude){
        ...
        forecast.workinDay(latitude,longitude,"1h",isFah);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0, size = allIntervals.length(); i < size; i++) {
                                ...
                                tempList.add(new TemperatureModel(date,temperature,weatherCode,"1h"));
                            }
